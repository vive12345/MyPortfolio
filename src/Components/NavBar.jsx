...
// //       {["About Me", "Skills", "Experience", "Projects", "Certification", "Education", "Contact Me"].map((item) => (
// //         <li key={item} className="p-1 transition-colors hover:text-teal-600 font-medium text-right">
// //           <button 
