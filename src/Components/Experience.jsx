              ...
              <div className="md:flex">
                <div className="md:w-1/4 bg-emerald-600 p-4 text-white flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-emerald-100 text-sm mb-1">{exp.company}</p>
                    <p className="text-sm text-emerald-200">{exp.location}</p>
                  </div>
                ...
                <div className="md:w-3/4 p-4">
                  <div className="mb-4">
                    <h4 className="text-md font-semibold text-gray-700 mb-2">Skills & Technologies</h4>
                    <div className="flex flex-wrap gap-1">
                      {exp.skills.map((skill, i) => (
                        <span key={i} className="bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full text-xs">
                          {skill}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h4 className="text-md font-semibold text-gray-700 mb-2">Key Achievements</h4>
